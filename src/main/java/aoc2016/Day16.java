...
// 
// Once the data has been generated, you also need to create a checksum of that data. Calculate the checksum only for the data that fits 
// on the disk, even if you generated more data than that in the previous step.
// 
...
// characters match (00 or 11), the next checksum character is a 1. If the characters do not match (01 or 10), the next checksum character 
// is a 0. This should produce a new string which is exactly half as long as the original. If the length of the checksum is even, 
...
// --- Part Two ---
// The second disk you have to fill has length 35651584. Again using the initial state in your puzzle input, what is the correct checksum 
// for this disk?
//
...
public class Day16 {
	...
	public static void main(String[] args) {		
		...
		String checksum = data.substring(0, DISK_LENGTH);
...
//		System.out.println(data.length());
	...
	private static String dragonCurve(String input) {
		...
		reversed = sb.reverse().toString().replaceAll("0", "x").replaceAll("1", "0").replaceAll("x", "1");
